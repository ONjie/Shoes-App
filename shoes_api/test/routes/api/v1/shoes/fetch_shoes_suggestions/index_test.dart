...
import '../../../../../../routes/api/v1/shoes/fetch_shoes_suggestions/index.dart'
    as route;
...
void main() {
  ...
  group('GET /', () {
    ...
    test(
        'should HttpStatus.badRequest and an error message when title is not provided',
        () async {
      //arrange
    ...
    test(
        'should HttpStatus.notFound and an error message when fetchShoesSuggestions returns a Left',
        () async {
      //arrange
      when(() => mockRequest.method).thenReturn(HttpMethod.get);
      when(() => mockRequest.uri).thenReturn(
    ...
    test(
        'should HttpStatus.ok and a Json list of shoes when fetchShoesSuggestions returns a Right',
        () async {
      //arrange
      when(() => mockRequest.method).thenReturn(HttpMethod.get);
      when(() => mockRequest.uri).thenReturn(
