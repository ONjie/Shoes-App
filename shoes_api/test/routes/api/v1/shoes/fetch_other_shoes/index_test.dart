...
import '../../../../../../routes/api/v1/shoes/fetch_other_shoes/index.dart'
    as route;
...
void main() {
  ...
  group('GET /', () {
    ...
    test(
        'should HttpStatus.notFound and an error message when fetchOtherShoes returns a Left',
        () async {
      //arrange
    ...
    test(
        'should HttpStatus.ok and a Json list of shoes when fetchOtherShoes returns a Right',
        () async {
      //arrange
      when(() => mockRequest.method).thenReturn(HttpMethod.get);
      when(
