...
class UpdateDeliveryDestination {
  UpdateDeliveryDestination({required this.deliveryDestinationRepository});
  ...
  }) async => await deliveryDestinationRepository.updateDeliveryDestination(
