...
void main() {
  late FetchPopularShoesByBrand fetchPopularShoesByBrand;
  late MockShoesRepository mockShoesRepository;

  setUp(() {
    mockShoesRepository = MockShoesRepository();

    fetchPopularShoesByBrand = FetchPopularShoesByBrand(
  ...
  test('should return Right(List<ShoeEntity>) from ShoesRepository', () async {
    ...
    //act
    final result = await fetchPopularShoesByBrand.call(brand: tBrand);
